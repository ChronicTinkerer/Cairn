...
local methods = {		
	...
	['ApplySettings'] = function(self)		
		...
		editBox:SetJustifyH(settings.justifyH)
		editBox:SetJustifyV(settings.justifyV)			
	end,
	...
	['SetGripSize'] = function(self)			
		...
		local gripSize 				= Tools:Round(trackSize * windowContentRatio)
	...
	['SetScrollThumbPosition'] = function(self)
		...
		local gripPositionOnTrack 	= Tools:Round(trackScrollAreaSize * windowPositionRatio)			
