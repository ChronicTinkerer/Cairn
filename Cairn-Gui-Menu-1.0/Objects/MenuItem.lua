...
local Menu 	= LibStub("Cairn-Gui-Menu-1.0")
-- ~~| Libraries |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
local methods = {
	...
	['ApplySettings'] = function(self)
		...
		local textWidth = Tools:Round(text:GetStringWidth()) + 10
...
local function Constructor()
	...
	-- ~~ Construct ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	frame:SetScript("OnClick", function(this,button) Gui:OnMouse(this,button); self:OnClick() end)
	frame:SetScript('OnEnter', function(this) self:OnEnter() end)
	frame:SetScript('OnLeave', function(this) Menu:StartCloseTimer() end)	
