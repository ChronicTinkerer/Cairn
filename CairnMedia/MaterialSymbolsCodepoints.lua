--[[
Cairn-Media: Material Symbols full codepoint table

Auto-generated from Google Fonts material-design-icons.git
(variablefont/MaterialSymbolsOutlined[FILL,GRAD,opsz,wght].codepoints).
Same codepoints work across Outlined / Rounded / Sharp -- only the
rendered glyph shape differs.

License: Apache 2.0 (see Assets/Public/fonts/Material_Symbols_*/LICENSE.txt)

Total entries: 4244
]]

local MAJOR = "Cairn-Media-1.0"
local lib = LibStub and LibStub(MAJOR, true)
if not lib then return end

lib._materialSymbolsCodepoints = {
	["10k"] = 0xE951,
	["10mp"] = 0xE952,
	["11mp"] = 0xE953,
	["123"] = 0xEB8D,
...
for name, cp in pairs(lib._materialSymbolsCodepoints) do
	if lib._icons[name] == nil then
		lib._icons[name] = cp
	end
end
